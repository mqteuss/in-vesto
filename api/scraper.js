...
// --- SCRAPER DE FUNDAMENTOS (ATUALIZADO PARA AÇÕES E FIIS) ---
async function scrapeFundamentos(ticker) {
    try {
        ...
        // 1. Dicionário Expandido (Campos FIIs + Campos Ações)
        let dados = {
            // Comuns / FIIs
            ...
            // Novos campos exclusivos de Ações
        ...
        // Extração por Cards (Importante para Ações no site Investidor10)
