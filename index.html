                        ...
                        options: {
                            ...
                            scales: {
                                y: {
                                    beginAtZero: true,
                                    grid: { color: '#2A2A2A' }, 
                                    // === MODIFICADO: Oculta os valores do Eixo Y ===
                                    ticks: { display: false }
                                },
